...
/**
 * Creates the window, places the character, and spawns 12 coins.
...
/**
 * Moves and draws every coin, checks for collision with the player,
 * and removes any coin that is touched. Displays the score.
